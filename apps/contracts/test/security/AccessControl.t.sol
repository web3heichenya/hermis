...
contract MockAdoptionStrategy is IAdoptionStrategy {
    function evaluateSubmission(uint256, uint256 approveCount, uint256 rejectCount, uint256 totalReviews, uint256)
        external
        pure
        override
...
contract AccessControlTest is Test {
    ...
    function testUnauthorizedContractCall_SubmissionRestore() public {
        ...
        submissionManager.restoreSubmissionStatus(
            testSubmissionId, DataTypes.SubmissionStatus.ADOPTED, "Unauthorized restore attempt"
        );
    }
