...
contract BasicRewardStrategyTest is Test {
    ...
    function testCalculateRewardDistribution_StandardCase() public {
        ...
        DataTypes.RewardDistribution memory distribution =
            rewardStrategy.calculateRewardDistribution(1, totalReward, 123, 3);
    ...
    function testCalculateRewardDistribution_WithRounding() public {
        ...
        uint256 totalDistributed = distribution.creatorShare + distribution.reviewerShare + distribution.platformShare
    ...
    function testCalculateRewardDistribution_LargeNumbers() public {
        ...
        DataTypes.RewardDistribution memory distribution =
            rewardStrategy.calculateRewardDistribution(1, totalReward, 123, 1000);
