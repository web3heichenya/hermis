...
contract SimpleAdoptionStrategyTest is Test {
    ...
    function testEvaluateSubmission_Rejection_Success() public {
        ...
        (DataTypes.SubmissionStatus newStatus, bool shouldChange, string memory reason) =
            adoptionStrategy.evaluateSubmission(1, 1, 3, 5, 1 days);
    ...
    function testEvaluateSubmission_InsufficientReviews() public {
        ...
        (DataTypes.SubmissionStatus newStatus, bool shouldChange, string memory reason) =
            adoptionStrategy.evaluateSubmission(1, 2, 0, 2, 1 days);
    ...
    function testEvaluateSubmission_NoThresholdMet() public {
        ...
        (DataTypes.SubmissionStatus newStatus, bool shouldChange, string memory reason) =
            adoptionStrategy.evaluateSubmission(1, 2, 1, 5, 1 days);
    ...
    function testEvaluateSubmission_TimeBasedExpiration() public {
        ...
        (DataTypes.SubmissionStatus newStatus, bool shouldChange, string memory reason) =
            adoptionStrategy.evaluateSubmission(1, 2, 1, 3, 8 days);
    ...
    function testEvaluateSubmission_AutoAdoption() public {
        ...
        (DataTypes.SubmissionStatus newStatus, bool shouldChange, string memory reason) =
            adoptionStrategy.evaluateSubmission(1, 0, 0, 0, 4 days);
    ...
    function testEvaluateSubmission_ExactThresholdValues() public {
        ...
        (DataTypes.SubmissionStatus newStatus, bool shouldChange, string memory reason) =
            adoptionStrategy.evaluateSubmission(1, 3, 2, 5, 1 days);
    ...
    function testEvaluateSubmission_MaximumThresholds() public {
        ...
        // Test approval
        (DataTypes.SubmissionStatus newStatus, bool shouldChange,) =
            adoptionStrategy.evaluateSubmission(1, 1, 1, 2, 1 days);
    ...
    function testEvaluateSubmission_ZeroReviews_NoAutoAdoption() public {
        ...
        (DataTypes.SubmissionStatus newStatus, bool shouldChange, string memory reason) =
            adoptionStrategy.evaluateSubmission(1, 0, 0, 0, 1 days);
    ...
    function testEvaluateSubmission_LargeNumberOfReviews() public {
        ...
        (DataTypes.SubmissionStatus newStatus, bool shouldChange, string memory reason) =
            adoptionStrategy.evaluateSubmission(1, 610, 390, 1000, 1 days);
