...
contract ArbitrationManagerTest is Test {
    ...
    function testRequestUserArbitration_Success() public {
        ...
        uint256 arbitrationId =
            arbitrationManager.requestUserArbitration(BOB, "Reputation penalty was unfair", DEFAULT_ARBITRATION_FEE);
    ...
    function testRequestSubmissionArbitration_Success() public {
        ...
        uint256 arbitrationId = arbitrationManager.requestSubmissionArbitration(
            submissionId, "Submission was unfairly rejected", DEFAULT_ARBITRATION_FEE
        );
    ...
    function testResolveArbitration_ApproveUserReputation() public {
        ...
        arbitrationManager.resolveArbitration(
            arbitrationId, DataTypes.ArbitrationStatus.APPROVED, "Penalty was indeed excessive"
        );
    ...
    function testResolveArbitration_RejectUserReputation() public {
        ...
        vm.prank(ADMIN);
        arbitrationManager.resolveArbitration(
            arbitrationId, DataTypes.ArbitrationStatus.REJECTED, "Penalty was justified"
        );
    ...
    function testCanRequestArbitration_UserReputation() public {
        ...
        vm.prank(ALICE);
        (bool canRequest, string memory reason) =
            arbitrationManager.canRequestArbitration(DataTypes.ArbitrationType.USER_REPUTATION, uint256(uint160(ALICE)));
