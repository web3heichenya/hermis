...
interface ITreasury {
    ...
    event FundsDeposited(
        address indexed depositor, address indexed token, uint256 amount, uint256 indexed taskId, string purpose
    );
    ...
    event FundsWithdrawn(
        address indexed recipient, address indexed token, uint256 amount, uint256 indexed taskId, string purpose
    );
