...
contract Treasury is ITreasury, Ownable, ReentrancyGuard, Pausable {
    ...
    modifier validPurpose(string calldata purpose) {
        ...
        if (
            purposeHash != keccak256("task") && purposeHash != keccak256("stake")
                && purposeHash != keccak256("arbitration") && purposeHash != keccak256("platform")
        ) {
    ...
    function depositTaskReward(uint256 taskId, address token, uint256 amount)
        external
        payable
        override
        onlyAuthorized
    ...
    function depositStake(address user, address token, uint256 amount)
        external
        payable
        override
        onlyAuthorized
    ...
    function depositArbitrationFee(uint256 arbitrationId, address token, uint256 amount)
        external
        payable
        override
        onlyAuthorized
    ...
    function withdrawTaskReward(uint256 taskId, address recipient, address token, uint256 amount)
        external
        override
        onlyAuthorized
        whenNotPaused
    ...
    function withdrawStake(address user, address token, uint256 amount)
        external
        override
        onlyAuthorized
        whenNotPaused
    ...
    function withdrawArbitrationFee(uint256 arbitrationId, address recipient, address token, uint256 amount)
        external
        override
        onlyAuthorized
        whenNotPaused
    ...
    function withdrawPlatformFees(address recipient, address token, uint256 amount)
        external
        override
        onlyOwner
        whenNotPaused
    ...
    function getBalance(address token, string calldata purpose, uint256 id)
        external
        view
        override
