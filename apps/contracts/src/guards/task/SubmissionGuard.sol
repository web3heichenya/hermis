...
contract SubmissionGuard is BaseGuard {
    ...
    function _performValidation(address user, bytes calldata data)
        internal
        view
        override
    ...
    function _validateSubmissionHistory(address user, SubmissionConfig memory config)
        internal
        pure
        returns (bool success, string memory reason)
    {
    ...
    function _validateTaskSpecificData(address user, bytes calldata data, SubmissionConfig memory config)
        internal
        pure
        returns (bool success, string memory reason)
    {
