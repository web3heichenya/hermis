...
contract ReviewGuard is BaseGuard {
    ...
    function _validateReviewHistory(address user, ReviewConfig memory config)
        internal
        pure
        returns (bool success, string memory reason)
    {
    ...
    function _validateTaskSpecificData(address user, bytes calldata data, ReviewConfig memory config)
        internal
        pure
        returns (bool success, string memory reason)
    {
