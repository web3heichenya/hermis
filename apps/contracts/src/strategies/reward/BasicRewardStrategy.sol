...
contract BasicRewardStrategy is IRewardStrategy, Ownable {
    ...
    function calculateRewardDistribution(
        ...
        uint256 calculatedTotal = distribution.creatorShare + distribution.reviewerShare + distribution.platformShare
        ...
        if (calculatedTotal > totalReward) {
            ...
            distribution.platformShare =
                totalReward - distribution.creatorShare - distribution.reviewerShare - distribution.publisherRefund;
        }
    ...
    function _validateConfig(bytes calldata config) internal pure {
        ...
        if (
            rewardConfig.creatorPercentage > 100 || rewardConfig.reviewerPercentage > 100
